<?php 
	...
	if (isset($_POST['liked'])) {
		$postid = $_POST['postid'];
		$result = mysqli_query($link, "SELECT * FROM images WHERE id=$postid");
	...
	$posts = mysqli_query($link, "SELECT * FROM images");
?>
<!DOCTYPE html>
<html lang="en">
<head>
		...
		<?php while ($row = mysqli_fetch_array($posts)) { ?>
			...
			<div class="post">
				...
				<?php 
					...
					$results = mysqli_query($link, "SELECT * FROM likes WHERE userid=1 AND postid=".$row['id']."");
